...
export class CannotCloseWithDeposits extends Error {
  static readonly code = 6011
  readonly code = 6011
  readonly name = "CannotCloseWithDeposits"
  readonly msg = "The lottery pool cannot be closed because it has deposits"

  constructor(readonly logs?: string[]) {
    super("6011: The lottery pool cannot be closed because it has deposits")
  }
}
...
export function fromCode(code: number, logs?: string[]): CustomError | null {
  switch (code) {
    ...
    case 6011:
      return new CannotCloseWithDeposits(logs)
  }
